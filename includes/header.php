...
<header>
    <div class="container">
        <div class="row">
            <nav id="menu" class="navbar navbar-expand-lg navbar-light nav-header">
                    ...
                    <div class="container">
                        <div class="row pb-4 icons-header hidden-mobile">
                            <p><img src="assets/images/icon-clock.png"
                                ...
                                <a href="https://www.facebook.com/clinicadoutordental/" target="_blank"> <img
                                            src="assets/images/facebook.png"
                                            alt="Icone phone da Agebem">
                                    /doutordental</a>

                                <a href="https://www.instagram.com/clinicadoutordental/" target="_blank"> <img
