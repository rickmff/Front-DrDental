    ...
    <div class="whats-elem">
        <div class="header-whats">
            <div class="row">
                ...
                <div class="close-window" style="top: 0px; left: 190px; position: absolute;">
    ...
    transform: scale(1.5);"></i></a>
        ...
        <form class="form-whats" name="formConsultaWindow" id="formConsultaWindow" action="javascript:" method="post"
            ...
            <div class="form-group col-md-12">
                <label>Nome:*</label>
                <input required="" type="text" class="nome form-control" placeholder="Digite seu nome"
                       autocomplete="nome">
            </div>
            <div class="form-group col-md-12">
                <label>Celular:*</label>
                <input required="" type="text" class="celular form-control mask_phone" placeholder="Digite seu celular"
